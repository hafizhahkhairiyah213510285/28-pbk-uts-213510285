<template>
  <div>
    ...
    <form>
      ...
      <input type="date" id="tanggal" v-model="kegiatan.tanggal">
    </form>
...
<style>
  ...
  body {
  background-image: url('https://img.freepik.com/premium-vector/hand-drawn-aesthetic-abstract-background_602158-5.jpg');
